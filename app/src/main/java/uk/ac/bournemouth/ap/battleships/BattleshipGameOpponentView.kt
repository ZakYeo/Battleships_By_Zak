 ...
 */
class BattleshipGameOpponentView : Game {
    ...
    var opponent = StudentBattleshipOpponent(rowCount, colCount, opponentGrid.opponent.ships as List<StudentShip>)
